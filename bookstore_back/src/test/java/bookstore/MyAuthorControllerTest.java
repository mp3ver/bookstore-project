...
public class MyAuthorControllerTest {
...
//    MockMvc mockMvc;
    ...
    MyAuthorRepository myAuthorRepository;
        ...
        List<MyAuthor> authors = myAuthorRepository.findAll();
        String authorsJson = new Gson().toJson(authors);

//        mockMvc.perform(get("/admin/authors").contentType(MediaType.APPLICATION_JSON))
